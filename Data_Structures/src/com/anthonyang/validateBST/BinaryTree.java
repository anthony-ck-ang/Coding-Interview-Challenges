package com.anthonyang.validateBST;
...
/*
 * Time Complexity: O(n) -> traverse each element once -> nth element
 * Auxiliary Space O(1) -> not storing and keeping track of previous node in memory
 */
